...
if getexecutorname then 
    if getexecutorname() == "Valyse" or getexecutorname() == "Electron" then 
        game.Players.LocalPlayer:Kick("Please switch to a fluxus based exploit!\n(due to detections)\nWe'd recommend using either fluxus or comet!")
    end
end
local players = game:GetService("Players")
...
LeftGroupBox:AddSlider("Autoparry FOV", {
    Text = "Autoparry FOV",
    Default = 180,
    Min = 0,
    Max = 360,
...
LeftGroupBox:AddSlider("Kanaboo", {
...
LeftGroupBox:AddSlider("Kusarigima", {
